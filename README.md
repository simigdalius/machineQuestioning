...
> A retro terminal-themed quiz web application designed to test your knowledge on fundamental Machine Learning concepts. 
...
## 🛠️ Εγκατάσταση και Εκτέλεση (Local Setup)
